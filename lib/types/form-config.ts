...
export const DEFAULT_FORM_CONFIG: FormConfig = {
  ...
  fields: [
    ...
    },
    {
      ...
      type: 'checkbox',
      name: 'whatsappOptIn',
      label: 'Recibir recordatorios por WhatsApp',
      required: false,
      section: 'customer',
      order: 4,
      visible: true,
    ...
    },
    {
      ...
      width: 'third',
      options: [
        { value: 'short', label: 'Pelo corto' },
        { value: 'medium', label: 'Pelo mediano' },
        { value: 'long', label: 'Pelo largo' },
        { value: 'curly', label: 'Pelo rizado' },
        { value: 'double', label: 'Doble capa' },
      ],
    },
    {
      id: 'notes',
      ...
      placeholder: 'Alergias, comportamiento especial...',
      required: false,
      section: 'pet',
      order: 6,
      visible: true,
